...
<AssetObjects::TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/ArtDev/Resources/Marble/03_Texture/RES_Marble_G.tga"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3177124793</m_ExportedTime>
	<m_ClassName text="Generic_Gloss"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="RES_Marble_G.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="RES_Marble_G"/>
	<m_Description text=""/>
	<m_Tags>
